...
final class BlackWhitePack implements Pack {
    private static final Random rand = new Random();
    private static final int PACK_SIZE = 1;

    private static final BasicCard[] COMMON_CARDS = {
            new BasicCard("Luminous Priest", 8, 30, "Common", null),
            new BasicCard("Shadow Phantom", 8, 30, "Common", null),
            new BasicCard("Ivory Knight", 8, 30, "Common", null),
            new BasicCard("Nightmare Specter", 8, 30, "Common", null)
    };


    private static final BasicCard[] UNCOMMON_CARDS = {
            new BasicCard("Grayscale Trickster", 8, 30, "Uncommon", null),
            new BasicCard("Void Mage", 8, 30, "Uncommon", null)
    };
