...
final class OceanPack implements Pack {
    private static final Random rand = new Random();
    private static final int PACK_SIZE = 1;

    private static final BasicCard[] COMMON_CARDS = {
            new BasicCard("Coral Siren", 8, 30, "Common", null),
            new BasicCard("Wishblossom", 8, 30, "Common", null)
    };


    private static final BasicCard[] UNCOMMON_CARDS = {
            new BasicCard("Tidal Leviathan", 8, 30, "Uncommon", null)
    };

    private static final BasicCard[] RARE_CARDS = {
            new BasicCard("Sea Turtle Sentinel", 8, 30, "Rare", null),
            new BasicCard("Kraken's Tentacle", 8, 30, "Rare", null)
    };

    private static final BasicCard[] EPIC_CARDS = {
            new BasicCard("Pearl Warden", 8, 30, "Epic", null)
    };
