...
public class Normal_Pack implements Pack {
    ...
    private static Card createNewCard(Card[] cardPool) {
        ...
        return new Card(template.getName(), template.getAttack(), template.getOriginalHealth(),
                template.getRarity(), template.hasDoubleAttack(), template.hasRevive());
    }
}
