...
final class ForestPack implements Pack {
    ...
    private static final BasicCard[] UNCOMMON_CARDS = {
            new BasicCard("Twilight Witch", 8, 30, "Uncommon", null),
            new BasicCard("Wishblossom", 8, 30, "Uncommon", null)
    };

    private static final BasicCard[] RARE_CARDS = {
            new BasicCard("Forest Spirit", 8, 30, "Rare", null)
    };

    private static final BasicCard[] EPIC_CARDS = {
            new BasicCard("Meadow Warden", 8, 30, "Epic", null),
            new BasicCard("Lavender Spirit", 8, 30, "Epic", null)
    };

    private static final BasicCard[] LEGENDARY_CARDS = {
            new BasicCard("Blooming Dryad", 8, 30, "Legendary", null),
            new BasicCard("Forest Beast", 8, 30, "Legendary", null)
    };
